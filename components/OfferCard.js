...
export default function OfferCard({ name, price, img, subheading, id }) {
    return (
        <Link href={`/product/${id}`}>
            <div className="grid overflow-hidden grid-cols-3 grid-rows-5 bg-slate-50 shadow-xl h-80 w-72 rounded-xl mr-auto ml-auto p-2 m-4 hover:cursor-pointer">
