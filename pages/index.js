  ...
  return (
    <section className='w-full h-screen bg-gradient-radial my-4'>
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div className='hidden lg:block mt-[15vh] mr-[22vh]'>
          <img className='w-full' alt="beach day" src="/beach.svg" />
        </div>
      </div>
    </section>
  )
...
function StarsSection() {
  return (
    <section className='h-1/3 w-5/6 m-auto text-center my-4 mb-12'>
      <img src="5stars.svg" className='ml-auto mr-auto w-1/4' />
...
function FeatureSection({ imagePath, mainCaption, explanation, reversed }) {
  return (
    <section className='w-full h-1/3 flex justify-center flex-col ml-2 lg:flex-row my-24'>
      {reversed ? <img src={imagePath} className='mx-auto w-2/3 lg:mx-0 lg:w-1/4 lg:mr-60 lg:hidden' /> : <></>}
      {reversed ? <></> : <img src={imagePath} className='mx-auto lg:mx-0 w-2/3 lg:w-1/4 lg:mr-60 lg:block' />}
      ...
      {!reversed ? <></> : <img src={imagePath} className='mx-auto hidden lg:block lg:mx-0 w-2/3 lg:w-1/4 lg:ml-60' />}
    </section>
  )
}
...
function OpinionSection({ opinions }) {
  const opinionComponents = opinions.map((opinion) =>
    <SwiperSlide><Opinion name={opinion.name} avatar={opinion.avatar} heading={opinion.heading} paragraph={opinion.paragraph} /></SwiperSlide>
  )
  console.log(opinionComponents);
  return (
    <section>
...
function Opinion({ avatar, name, heading, paragraph }) {
  return (
    <div className='min-w-[384px]  min-h-[256px] w-2/5 bg-slate-200 rounded-xl grid overflow-hidden grid-lines grid-cols-6 grid-rows-3 gap-2 shadow-2xl my-12 items-center mr-auto ml-auto'>
      <div className="box row-start-1 row-end-3 col-start-1 col-end-3 flex justify-center items-center">
        <img className='lg:p-6' src={avatar} />
      </div>
...
function ContactForm() {
  ...
  return (
    <section className='w-screen h-2/5 flex flex-col lg:flex-row justify-center bg-gradient-radial my-12 py-12'>
      <img src="contact.svg" className='w-2/5' />
